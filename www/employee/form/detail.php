            ...
            <div class="col offset-sm-1 col-sm-10 offset-lg-2 col-lg-8">
                <div class="row">
                    ...
                    <div class="btn-reply col-12 col-sm-12 my-3 justify-content-end <?= $d ?>">
                        <button onclick="handleRejectForm('.btn-reply','<?=$form['form_id']?>')" type="button" class="btn btn-danger">Từ chối</button>
                        <button onclick="handleApproveForm('.btn-reply','<?=$form['form_id']?>')" type="button" class="btn btn-success ml-3">Đồng ý</button>
                    </div>
                </div>
            </div>
        </div>
