...
<body>
    <?php 
        ...
        $employee = get_employee(['emp_id','last_name','first_name'],['account_id'],[$account['account_id']],[],[],0)[0];
        $forms = get_form(['form_id','submit_day','status','emp_id'],['emp_id'],[$employee->emp_id],[],[],0);
   ?>

    <div class="container mt-4">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                <h2 class="mb-3 heading-tasks" onclick="handleReload()">Your Forms</h2>
