...
<body>
    <?php 
        ...
        $director = get_employee(['emp_id'],['account_id'],[$account['account_id']],[],[],0)[0];
        $forms = get_form(['form_id','submit_day','status','emp_id'],['manager_id'],[$director->emp_id],[],[],0);
   ?>

    <div class="container mt-4">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                <h2 class="mb-3 heading-tasks" onclick="handleReload()">Đơn nghỉ phép</h2>
